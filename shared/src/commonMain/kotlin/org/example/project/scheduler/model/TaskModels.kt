...
data class TaskPanel(
     ...
     * one means "regenerated by the placement", which is why
     * [org.example.project.scheduler.domain.SchedulerDomain.restrictivePeriodsOf] drops it
     * (a break is never an input to its own placement). This is the opposite — a break that really happened,
     * authoritative and synced like every other fact about the past.
     */
